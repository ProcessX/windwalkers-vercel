  ...
  render() {
    ...
    return (
      <div className={'page page--landing'}>
        ...
        <section className={'landing__section landing__section--intro pixelArt'} style={introStyle}>
          ...
          <div className={'landing__content'}>
            ...
            <ul className={'concept__li'}>
              <li className={'concept__el'}>
                <div className={'concept__illu pixelArt'} style={conceptStyle01}>illu</div>
              ...
              <li className={'concept__el'}>
                <div className={'concept__illu pixelArt'} style={conceptStyle02}>illu</div>
          ...
          <div className={'landing__content'}>
            ...
            <ul className={'artwork__li'}>
              <li className={'artwork__el'}>
                <div className={'artwork__illu pixelArt'} style={artworkStyle01}>illu</div>
              ...
              <li className={'artwork__el'}>
                <div className={'artwork__illu pixelArt'} style={artworkStyle02}>illu</div>
